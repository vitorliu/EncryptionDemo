...
package com.example.encrylibrary.unsymmetric;
...
import com.example.encrylibrary.base.Base64;
import com.example.encrylibrary.base.CryptoProvider;
...
public class RSAUtil {
    ...
    private static KeyFactory getKeyFactory() throws NoSuchAlgorithmException,
        ...
        if (Build.VERSION.SDK_INT >= 24){
            keyFactory = KeyFactory.getInstance("RSA", new CryptoProvider());
    ...
    private static KeyPairGenerator getKeyPairGenerator() throws NoSuchProviderException,
        ...
        if (Build.VERSION.SDK_INT >= 24){
            keyPairGen = KeyPairGenerator.getInstance("RSA", new CryptoProvider());
        }else if (Build.VERSION.SDK_INT >= 16) {
