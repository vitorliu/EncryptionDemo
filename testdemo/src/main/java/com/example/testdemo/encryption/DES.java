...
public class DES {
	...
	/***************************************************************************
	 * function: DES parameter: u_char * key ; key for encode u_char * mtext ;
	...
	final int arrayLenth = 1024 * 1024 * 1;		//数组最大长度为1M

	public String Encode(String str) {
		int i1;

		String digestHexStr;
		byte[] byte2 = new byte[arrayLenth];
	...
	public String Decode(String str) {
		...
		byte[] byteMingW = new byte[arrayLenth]; // 密文
		byte[] byteMiW = new byte[arrayLenth];
		...
		String result = new String(byteMingW, 0, i2);
		return result.replaceAll(new String(new byte[]{0}), "").trim();
	}
	...
	public static void main(String args[]) {
		String key = "msd12345";
		DES m = new DES(key);
		String content = "http://192.168.100.12:8081/TCStandardService/phone/";
		String tmp = m.Encode(content);
